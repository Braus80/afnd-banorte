...
Razón: la tabla de gastos y la de planes comparan proporciones (31 % vs 8 %, 20.75 % vs 25.75 %) y un número solo no se lee de un vistazo en móvil; la barra es un refuerzo visual que no introduce props ni semántica nueva, así que no toca el contrato. Contraste del relleno sobre la pista como elemento gráfico: 3.9:1 en normal (#e4001b sobre #e6e6e6) y 3.3:1 en sencillo (sobre #d4d4d4), ambos ≥ 3:1 (AA). Sin animación.
